if {![info exists repo_root]} {
  ...
  set repo_root [file normalize [file join $workspace_root "FPGA_Auto_Project"]]
  if {![file exists [file join $repo_root "templates" "contexts" "timing_verification" "adapters" "tcl" "common.tcl"]]} {
