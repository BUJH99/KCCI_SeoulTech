# Build a Basys3 MicroBlaze block design around the SW_GPIO RTL and export XSA.
#
...
#
# Outputs:
#   output/vivado/sw_gpio_bd_project/
#   output/xsa/SW_GPIO_Basys3.xsa

set script_dir [file normalize [file dirname [info script]]]
set project_dir [file normalize [file join $script_dir ".."]]
set build_dir [file normalize [file join $project_dir "output" "vivado" "sw_gpio_buttons_bd_project"]]
set xsa_dir [file normalize [file join $project_dir "output" "xsa"]]
set xsa_file [file normalize [file join $xsa_dir "SW_GPIO_Basys3.xsa"]]
set bd_name "sw_gpio_bd"
set proj_name "SW_GPIO_Basys3"
...
if {[llength $rtl_files] == 0} {
  error "No SystemVerilog RTL files found under $project_dir/src"
}
add_files -fileset sources_1 $rtl_files
add_files -fileset constrs_1 [file join $project_dir "constrs" "basys3_sw_gpio_bd.xdc"]
...
create_bd_cell -type module -reference SwGpioCoreBd uSwGpioCore
set_property -dict [list \
  CONFIG.P_CLK_HZ {100000000} \
  CONFIG.P_COUNT_HZ {1} \
] [get_bd_cells uSwGpioCore]

create_bd_port -dir O -from 6 -to 0 oSeg
create_bd_port -dir O oDp
create_bd_port -dir O -from 3 -to 0 oDigitSel
create_bd_port -dir I -from 1 -to 0 iBtnCtrl

connect_bd_net $clk_port [get_bd_pins uSwGpioCore/iClk]
connect_bd_net $rstn_pin [get_bd_pins uSwGpioCore/iRstn]
connect_bd_net [get_bd_pins axi_gpio_ctrl/gpio_io_o] [get_bd_pins uSwGpioCore/iGpioCtrl]
connect_bd_net [get_bd_ports iBtnCtrl] [get_bd_pins axi_gpio_buttons/gpio_io_i]
connect_bd_net [get_bd_pins uSwGpioCore/oGpioStatus] [get_bd_pins axi_gpio_status/gpio_io_i]
connect_bd_net [get_bd_pins uSwGpioCore/oSeg] [get_bd_ports oSeg]
connect_bd_net [get_bd_pins uSwGpioCore/oDp] [get_bd_ports oDp]
connect_bd_net [get_bd_pins uSwGpioCore/oDigitSel] [get_bd_ports oDigitSel]
