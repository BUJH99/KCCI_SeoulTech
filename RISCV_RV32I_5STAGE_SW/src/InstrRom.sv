...
Summary:
  - Uses an initialized block-ROM style so larger software images still fit the Basys3 target
...
module InstrRom #(
  ...
  parameter string       P_INIT_FILE  = "C:/Users/tbdk5/Desktop/MAIN/0_Working/git/FPGA_Auto_Project/Project/RISCV_32I_5STAGE_SW/src/InstructionFORTIMING.mem"
)(
  ...
  // Prefer block RAM so larger software images, such as terminal games,
  // still fit cleanly on the Basys3 target.
